                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ old('name') }}" type="text" name="name" id="product-name" class="form-control" placeholder="Items Name">
                                                    @error('name')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ old('brand') }}" type="text" name="brand" id="product-brand" class="form-control" placeholder="Brand Name">
                                                    @error('brand')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-lg-4">
                                            <div class="mt-3">
                                                <h5 class="text-dark fw-medium">Size :</h5>
                                                <div class="d-flex flex-wrap gap-2" role="group" aria-label="Basic checkbox toggle button group">
                                                    <input  type="checkbox" name="size[]" value="xs" class="btn-check" id="size-xs1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control bg-light-subtle" value="{{ old('description') }}" name="description" id="description" rows="7" placeholder="Short description about the product"></textarea>
                                            </div>
                                            @error('description')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                <div class="mb-3">
                                                    ...
                                                    <input value="{{ old('stock') }}" type="number" name="stock" id="product-stock" class="form-control" placeholder="Quantity">
                                                    @error('stock')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" value="{{ old('price') }}" name="price" id="product-price" class="form-control" placeholder="000">
                                                </div>
                                                @error('price')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                        ...
                                        <div class="col-lg-4">
                                            <div>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input value="{{ old('discount') }}" type="number" name="discount" id="product-discount" class="form-control" placeholder="000">
                                                    @error('discount')
                                                    <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                </div>
