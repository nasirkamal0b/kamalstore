    ...
    <div class="container">
        ...
        <div class="products-details-desc">
            ...
            <ul class="products-info">
                ...
                <li><span>Availability:</span> <a href="#">In stock ({{$product->stock}} items)</a></li>
                <li><span>Products Type:</span> <a href="#">{{$product->name}}</a></li>
            </ul>
            ...
            <div class="products-add-to-cart">
                ...
                <form id="add-to-cart-form" style="display: inline;">
                    ...
                    <input type="hidden" name="product_image" value="{{ $product->images }}">
                    ...
                    $('#add-to-cart-form').submit(function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                $('#cart-message').html('<p style="color:green;">' + response.message + '</p>');
                            },
                            error: function(xhr, status, error) {
                                console.log(xhr.responseText); // Debugging
                                $('#cart-message').html('<p style="color:red;">Failed to add product to cart!</p>');
                            }
                        });
                    });
                });
